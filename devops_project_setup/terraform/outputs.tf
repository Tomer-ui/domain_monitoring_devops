resource "local_file" "ansible_inventory" {
  content = <<EOT
[master]
${aws_instance.jenkins_master.public_ip} ansible_user=ubuntu ansible_ssh_private_key_file=${abspath("../my-key.pem")} ansible_ssh_common_args='-o StrictHostKeyChecking=no'
